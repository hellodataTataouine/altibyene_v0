                                    ...
                                    <form action="">
                                        ...
                                        <div class="mb-3 d-flex justify-content-between">
                                            <button type="button" class="btn btn-primary" data-toggle="modal"
                                                data-target="#exampleModal" data-session-id="{{ $session->id ?? '' }}">
                                                {{ __('Add new chapter') }}
                                            </button>

                                            <button type="button" class="btn btn-primary sort-chapter-btn" data-session-id="{{ $session->id ?? '' }}">
                                                {{ __('Sort chapter') }}
                                            </button>
                                        ...
                                        <div class="accordion draggable-list" id="accordion">
                                            @forelse ($chapters as $chapter)
                                                @if ($chapter->session_id === $session->id)
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#exampleModal').on('show.bs.modal', function (event) {
                ...
                var sessionId = button.data('session-id'); // Extract session ID from data-* attributes

                var modal = $(this);
                modal.find('#session_id').val(sessionId); // Set session ID in hidden input
            });
        });
    </script>
@endpush
