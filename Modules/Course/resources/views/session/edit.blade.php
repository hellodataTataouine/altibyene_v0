                                ...
                                <form action="{{ route('admin.course-session.update',$session->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <select name="cours_id" class="form-control">
                                                @foreach ($courses as $cours)
                                                    <option value="{{ $cours->id }}" @selected($cours->id===$session->cours_id)>{{ $cours->title }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" id="start_date" class="form-control datepicker" name="start_date" value="{{ $session->start_date }}">
                                            @error('start_date')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" id="end_date" class="form-control datepicker" name="end_date" value="{{ $session->end_date }}">
                                            @error('end_date')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <select name="type" class="form-control">
                                                <option value="Online" @selected($session->type=="Online")>{{ __('Online') }}</option>
                                                <option value="Offline" @selected($session->type=="Offline")>{{ __('Offline') }}</option>
                                            </select>
                                            @error('type')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="number" id="max_enrollments" class="form-control" name="max_enrollments" step="1" value="{{ $session->max_enrollments }}" >
