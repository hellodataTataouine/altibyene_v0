...
@section('meta_title', 'Panier' . ' || ' . $setting->app_name)
                ...
                @foreach ($products as $item)
                    ...
                    @elseif (in_array($item?->course?->id, session()->get('instructor_courses')))
                        <div class="alert alert-danger d-flex align-items-center" role="alert">
                            ...
                            <div>
                                {{ __('Vous avez vos propres programme dans votre panier. Avant de continuer, veuillez les supprimer du panier. ') }}
                            </div>
                        </div>
                    @endif
                @endforeach
                            ...
                            <table class="table cart__table">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="product__name">{{ __('Programmes') }}</th>
