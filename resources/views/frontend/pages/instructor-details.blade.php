            ...
            <div class="row">
                        ...
                        @if ($courses->count() > 0)
                            <div class="instructor__details-courses">
                                <div class="row align-items-center mb-30">
                                    <div class="col-md-8">
                                        <h2 class="main-title">{{ __('Mes cours') }}</h2>
                                        <p>{{ __('Découvrez mes derniers cours') }}</p>
                                    </div>
                                    <div class="col-md-4">
                                                            ...
                                                            @else
                                                                <div class="button">
                                                                    <a href="javascript:;" class="add-to-cart"
                                                                        data-id="{{ $course->id }}">
                                                                        <span
                                                                            class="text">{{ __('Ajouter au panier') }}</span>
                                                                        <i class="flaticon-arrow-right"></i>
                                                                    </a>
                                                                </div>
                                                            @endif
                ...
                <div class="col-xl-3">
                    <div class="instructor__sidebar">
                        <h4 class="title">{{ __('Contact rapide') }}</h4>
                        <p>{{ __('N hésitez pas à me contacter par mail') }}!</p>
                        <form action="{{ route('quick-connect', $instructor->id) }}" method="POST">
                            ...
                            @endif
                            <button type="submit" class="btn arrow-btn">{{ __('Envoyer un message') }} <img
