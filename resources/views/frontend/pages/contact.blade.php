            ...
            <div class="row">
                ...
                <div class="{{ ($contact?->address || $contact?->phone_one || $contact?->phone_two || $contact?->email_one || $contact?->email_two) ? 'col-lg-8' : 'col-lg-12' }}">
                    <div class="contact-form-wrap">
                        <h4 class="title">{{ __('Envoyez-nous un message') }}</h4>
                        ...
                        <form id="contact-form" action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-grp">
                                        <input name="subject" type="text" placeholder="{{ __('Sujet') }} *" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-grp">
                                        <input name="name" type="text" placeholder="{{ __('Nom') }} *" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-grp">
