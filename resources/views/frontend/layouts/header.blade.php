                    ...
                    <div class="col-lg-6">
                        <ul class="tg-header__top-info list-wrap">
                            @if ($setting?->site_address)
                                <li><img src="{{ asset('frontend/img/banner/map-marker 1.svg') }}" alt="Icon" style="width:5%; height: auto;">
                                    <span>{{ $setting?->site_address }}</span>
                                </li>
                            @endif
                            @if ($setting?->site_email)
                                <li><img src="{{ asset('frontend/img/banner/envelope.svg') }}" alt="Icon" style="width:5%; height: auto;"> <a
                                    ...
                                    <ul class="navigation">
                                        ...
                                        @endforeach
                                              ...
                                              <li class="menu-item" style=" margin-left: 450px;">
                                                <a href="{{ url('/register') }}"class="btn btn-primary custom-btn" title=" Inscription"  style=" color: white;font-size:20px;">
