                ...
                <div class="col-xl-3 col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="features__item-six">
                        ...
                        <div class="features__content-six">
                            ...
                            <span>{{ $ourFeatures?->content?->sub_title_one }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6" >
                    <div class="features__item-six">
                        ...
                        <div class="features__content-six">
                            ...
                            <span>{{ $ourFeatures?->content?->sub_title_two }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item-six">
                        ...
                        <div class="features__content-six">
                            ...
                            <span>{{ $ourFeatures?->content?->sub_title_three }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="features__item-six">
                        ...
                        <div class="features__content-six">
                            ...
                            <span>{{ $ourFeatures?->content?->sub_title_four }}</span>
                        </div>
                    </div>
                </div>
            </div>
