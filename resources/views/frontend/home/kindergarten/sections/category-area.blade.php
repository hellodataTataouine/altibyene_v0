<section class="categories-area section-py-120 pt-0">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-7">
                <div class="section__title text-center mb-40">
                    <span class="sub-title">{{ __('inscription') }}</span>
                    <h2 class="title">{{ __('Comment vous inscrire ?') }}</h2>
                    <p class="desc">{{ __('Suivez ces quelques étapes pour finaliser votre inscription.') }}</p>
                </div>
            </div>
        </div>
        <div class="row">
